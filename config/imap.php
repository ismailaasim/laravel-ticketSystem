...
return [
    ...
    */
    'accounts' => [
        ...
        //     'username' => env('IMAP_USERNAME', 'praveen21berg@gmail.com'),
        //     'password' => env('IMAP_PASSWORD', 'zmyciruqdpdvndtv'),
        ...
        'gmail' => [ // account identifier
            ...
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => 'praveen21berg@gmail.com',
            'password' => 'zmyciruqdpdvndtv',
