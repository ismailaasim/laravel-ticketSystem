...
class ShipmentController extends Controller
{
    ...
    public function showShipment()
    {
        ...
        if ($user_id) {
            ...
            return view('Backend.shipment', compact('pageName', 'shipments', 'UsersCount', 'shipments_count', 'loggedInUserName', 'loggedInUserDesignation'));
        }
    }
